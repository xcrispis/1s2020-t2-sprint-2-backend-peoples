...
using senai.Pessoas.WebApi.Repositories;

namespace senai.Pessoas.WebApi.Controllers
{
    /// <summary>
    ...
    public class PessoasController : ControllerBase
    {
        ...
        public IActionResult GetById(int id)
        {
            ...
            if (PessoasBuscado == null)
            {
                ...
                return NotFound("Nenhuma Pessoa encontrado");
            }
        ...
        {
            // Cria um objeto PessoasBuscado que irá receber o Pessoas buscado no banco de dados
            PessoasDomain PessoasBuscado = _PessoasRepository.ListarPorNome(Nome);
